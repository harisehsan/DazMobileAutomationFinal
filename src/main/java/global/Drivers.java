...
public class Drivers {
    ...
    EnvPicker envPicker = new EnvPicker(driver);


//    public AppiumDriver Android_Launch_LazadaApp_Device1() throws MalformedURLException {
...
//        System.out.println("Harry1: "+driver);
//        return driver;
//    }

//    public AppiumDriver Android_Launch_LazadaApp_Device2() throws MalformedURLException {
//        cap = new DesiredCapabilities();
//        cap.setCapability(MobileCapabilityType.DEVICE_NAME, "687789700505");
//        cap.setCapability(MobileCapabilityType.PLATFORM_NAME, MobilePlatform.ANDROID);
