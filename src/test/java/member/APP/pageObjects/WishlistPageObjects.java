...
public class WishlistPageObjects {
    ...
    @AndroidFindBy (id = "com.daraz.android:id/wishlist") public WebElement wishlist_icon;
    ...
    @AndroidFindBy (id = "com.daraz.android:id/view_login_social_google") public WebElement google_btn;
    ...
    @AndroidFindBy (id = "com.daraz.android:id/snackbar_text") public WebElement wishlist_Success_Message_lbl;
    @AndroidFindBy (id = "com.shop.android:id/snackbar_text") public WebElement wishlist_Success_Message_lbl_MM;
    @AndroidFindBy (id = "com.daraz.android:id/snackbar_action") public WebElement go_To_Wishlist_btn;
    @AndroidFindBy (id = "com.shop.android:id/snackbar_action") public WebElement go_To_Wishlist_btn_MM;
    @AndroidFindBy (id = "com.daraz.android:id/title") public WebElement product_Name_lbl;
    ...
    @AndroidFindBy (id = "com.daraz.android:id/txt_login_signup") public WebElement login_Signup_btn;
    ...
    public By login_btn_By = By.id("com.daraz.android:id/btn_login_fresh_welcome_login");
    public By login_btn_By_MM = By.id("com.shop.android:id/btn_login_fresh_welcome_login");
    public By google_btn_By = By.id("com.daraz.android:id/view_login_social_google");
    ...
    public By wishlist_Success_Message_lbl_By = By.id("com.daraz.android:id/snackbar_text");
    public By wishlist_Success_Message_lbl_By_MM = By.id("com.shop.android:id/snackbar_text");
    public By go_To_Wishlist_btn_By = By.id("com.daraz.android:id/snackbar_action");
    ...
    public By login_Signup_btn_By = By.id("com.daraz.android:id/txt_login_signup");
