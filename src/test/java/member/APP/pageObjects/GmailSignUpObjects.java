...
public class GmailSignUpObjects {
    ...
    @AndroidFindBy(id="com.android.settings:id/next_button") public WebElement next_btn;
...
//    @AndroidFindBy(xpath="//*[@class='android.view.View']") public WebElement First_name_txt;
    ...
    @AndroidFindBy(className = "android.view.View") public List <WebElement> dob_txt;
    ...
    @AndroidFindBy(className = "android.widget.EditText") public WebElement create_Password_txt;
