...
public class FacebookSignUpObjects extends BuildIDPicker {
    @AndroidFindBy(id = "com.daraz.android"+dev+":id/view_login_social_facebook") public List <WebElement> facebook_btn;
    @AndroidFindBy(xpath="//*[@resource-id='android:id/button1']") public WebElement policy_Agree_btn;
    @AndroidFindAll({@AndroidBy(xpath = "//*[@content-desc='Username']"),@AndroidBy (id ="m_login_email") ,@AndroidBy(xpath = "//*[@text='Phone number or email address']")}) public List <WebElement> facebook_Email_txt;
    @AndroidFindAll({@AndroidBy(xpath = "//*[@content-desc='Password']"),@AndroidBy(id = "m_login_password"),@AndroidBy(xpath = "//*[@text='Password']")}) public List <WebElement> facebook_Password_txt;
    @AndroidFindBy(id = "com.shop.android:id/view_login_social_facebook") public List <WebElement> facebook_btn_MM;
