...
public class FacebookSignUpObjects  {
    ...
    @AndroidFindAll({@AndroidBy(xpath = "//*[@content-desc='Username']"),@AndroidBy(xpath = "//*[@text='Phone number or email address']")}) public WebElement facebook_Email_txt;
    @AndroidFindAll({@AndroidBy(xpath = "//*[@content-desc='Password']"),@AndroidBy(xpath = "//*[@text='Password']")}) public WebElement facebook_Password_txt;
    @AndroidFindBy(id = "com.shop.android:id/view_login_social_facebook") public WebElement facebook_btn_MM;
    @AndroidFindAll({@AndroidBy(xpath = "//*[@content-desc='Login click']"),@AndroidBy(xpath = "//*[@contentDescription='Login click']")}) public List <WebElement> facebook_login_btn;
