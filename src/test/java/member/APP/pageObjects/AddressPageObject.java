...
public class AddressPageObject {
    ...
    @AndroidFindBy (id = "com.daraz.android:id/btn_edit") public List<WebElement> edit_Address_btn;
    @AndroidFindBy (id = "com.shop.android:id/btn_edit") public List <WebElement> edit_Address_btn_MM;
    @AndroidFindBy (id = "com.daraz.android:id/text_input_layout") public List <WebElement> address_Text_Input_layout;
    @AndroidFindBy (id = "com.shop.android:id/text_input_layout") public List <WebElement> address_Text_Input_layout_MM;
    @AndroidFindBy (id = "com.daraz.android:id/text_input_edit_text") public List <WebElement> address_Text_Input_txtbox;
    @AndroidFindBy (id = "com.shop.android:id/text_input_edit_text") public List <WebElement> address_Text_Input_txtbox_MM;
    @AndroidFindBy (id = "com.daraz.android:id/tv_address_location_tree_name") public List <WebElement> address_Location_Tree_lbl;
    ...
    public By address_Text_Input_layout_By = By.id("com.daraz.android:id/text_input_layout");
    public By address_Text_Input_layout_By_MM = By.id("com.shop.android:id/text_input_layout");
    public By address_Location_Tree_lbl_By = By.id("com.daraz.android:id/tv_address_location_tree_name");
