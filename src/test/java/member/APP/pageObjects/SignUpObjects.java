...
public class SignUpObjects {
    ...
    @AndroidFindBy (id="com.daraz.android:id/img_head_settings") public WebElement settings_icon;
    ...
    @AndroidFindBy (id="com.shop.android:id/img_head_settings") public WebElement settings_icon_MM;
    ...
    public By settings_icon_By = By.id("com.daraz.android:id/img_head_settings");
    ...
    public By settings_icon_By_MM = By.id("com.shop.android:id/img_head_settings");
}