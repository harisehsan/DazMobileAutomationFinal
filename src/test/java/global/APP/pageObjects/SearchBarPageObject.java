...
public class SearchBarPageObject {
    @AndroidFindBy(id = "com.daraz.android:id/laz_homepage_scan_icon") public List<WebElement> scan_icon;
    @AndroidFindBy(id = "com.shop.android:id/laz_homepage_scan_icon") public List<WebElement> scan_icon_MM;
    @AndroidFindBy(id = "com.daraz.android:id/laz_homepage_scan_text") public List <WebElement> scan_Text_lbl;
    ...
    @AndroidFindBy (id = "com.daraz.android:id/laz_homepage_search_view") public List <WebElement> searchbar_txt;
    @AndroidFindBy (id = "com.shop.android:id/laz_homepage_search_view") public List <WebElement> searchbar_txt_MM;
    @AndroidFindBy (id = "com.daraz.android:id/laz_homepage_right_wallet_icon") public List <WebElement> wallet_icon;
    @AndroidFindBy (id = "com.shop.android:id/laz_homepage_right_wallet_icon") public List <WebElement> wallet_icon_MM;
    @AndroidFindBy (id = "com.daraz.android:id/laz_homepage_right_wallet_text") public List <WebElement> wallet_Name_lbl;
    ...
    public By wallet_icon_By = By.id("com.daraz.android:id/laz_homepage_right_wallet_icon");
