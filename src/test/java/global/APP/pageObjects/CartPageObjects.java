...
public class CartPageObjects extends BuildIDPicker {
    ...
    @AndroidFindBy(id = "com.daraz.android"+dev+":id/tv_laz_trade_order_total_amount") public List <WebElement> displayed_Amount_txt;
    @AndroidFindBy(id = "com.shop.android:id/tv_laz_trade_order_total_amount")  public List <WebElement> displayed_Amount_txt_MM;
    @AndroidFindBy(id = "com.daraz.android"+dev+":id/tv_laz_trade_total_bar_fee_value") public List <WebElement> original_Amount_txt;
