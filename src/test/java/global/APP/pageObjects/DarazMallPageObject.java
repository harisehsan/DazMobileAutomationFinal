...
public class DarazMallPageObject {
    ...
    @AndroidFindBy (xpath = "//*[@text='SHOP MORE >']") public List <WebElement> shop_More_btn;
    ...
    @AndroidFindBy (xpath = "//*[@text='DarazMall']") public List <WebElement> daraz_Mall_Title_lbl_MM;
