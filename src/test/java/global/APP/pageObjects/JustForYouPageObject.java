...
public class JustForYouPageObject {
    @AndroidFindBy(xpath = "//*[@text='Just For You']") public List<WebElement> just_For_You_title_lbl;
    @AndroidFindBy(id = "com.daraz.android:id/discount") public List<WebElement> discount_lbl;
    @AndroidFindBy(id ="com.daraz.android:id/product_title") public List<WebElement> product_Title_lbl;
    @AndroidFindBy(id = "com.daraz.android:id/product_display_price") public List <WebElement> display_Price_lbl;
    @AndroidFindBy(id = "com.daraz.android:id/product_original_price") public List <WebElement> original_Price_lbl;
    @AndroidFindBy(id = "com.daraz.android:id/rating_bar") public List <WebElement> rating_bar;
    @AndroidFindBy(id = "com.daraz.android:id/tv_price") public WebElement display_Price_On_Pdp_lbl;
    @AndroidFindBy(id = "com.daraz.android:id/tv_origin_price") public WebElement original_Price_On_Pdp_lbl;
    @AndroidFindBy(id= "com.daraz.android:id/tv_discount") public List <WebElement> discount_Pdp_lbl;
    @AndroidFindBy(id= "com.daraz.android:id/rating_layout") public List <WebElement> rating_Pdp_bar;
    @AndroidFindBy(id = "com.daraz.android:id/title") public WebElement product_Title_pdp;
