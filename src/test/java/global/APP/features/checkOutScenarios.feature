...
#      | bd.live  |
  ...
  @validate_the_order_price_in_cart_for_single_product_and_match_with_PDP_use_multiple_quantity
  Scenario: validate the order price in cart for single product and match with PDP use multiple quantity products
    Given I select the venture
    And I select cart
    And I login with old buyer account
    And I skip the cart popup
  ...
  @validate_the_order_price_in_cart_and_match_with_PDP_use_single_product_with_multiple_quantity
  Scenario: validate the order price in cart and match with PDP use seller voucher product with multiple quantity
    Given I select the venture
    And I select cart
    And I login with old buyer account
    And I skip the cart popup
  ...
  @validate_the_order_price_in_cart_and_match_with_PDP_use_multiple_products_with_same_seller_with_voucher
  Scenario: validate the order price in cart and match with PDP use multiple products with same seller with voucher
    Given I select the venture
    And I select cart
    And I login with old buyer account
    And I skip the cart popup
  ...
  @validate_the_order_price_in_cart_and_match_with_PDP_use_multiple_products_with_same_sellers_free_shipping
  Scenario: validate the order price in cart and match with PDP use multiple products with same sellers with free shipping
    Given I select the venture
    And I select cart
    And I login with old buyer account
    And I skip the cart popup
