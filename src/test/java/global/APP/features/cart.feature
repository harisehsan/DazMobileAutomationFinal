...
#    Then I verify that all items in cart are successfully removed
  ...
  @21001151 @add_free_gift_item_into_cart @28810188 @28810219 @28810187 @28810186
  ...
  @21001151 @add_buy_one_get_one_item_into_cart @28810195 @28810222 @28810196 @28810197
